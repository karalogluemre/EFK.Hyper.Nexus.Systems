...
using EFK.System.Persistence.Injection.CDC;
using EFK.System.Persistence.Injection.Config.AppByteService;
using EFK.System.Persistence.Injection.ElasticSearch;
using EFK.System.Persistence.Injection.RabbitMQ;
...
namespace Insure.Persistence.Injection
{
    public static class FeaturesDependencyInjections
    {
        public static void FeaturesDependencyInjectionServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            #region Swagger
            services.SwaggerGenRegistration(configuration);

            #endregion

            #region Mapping Profile
            services.ApplyAllConfigurations(configuration);
            #endregion

            #region Common Dependency Injection
            services.CommonDependencyInjectionService(configuration);

            #endregion

            #region Rabbit  Injection
            services.RabbitMQDependencyInjectionService(configuration);
            services.ElasticSearchDependencyInjectionService(configuration);
            #endregion


            #region CDC 
            services.CdcDependencyInjectionService(configuration);
            #endregion
            ...
            services.AddScoped<IRequestHandler<GetPackageByIdQueryRequest, Package>, GetPackageByIdQueryHandler<ApplicationDbContext>>();
            #endregion
